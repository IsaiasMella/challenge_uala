    ...
    <DayPicker
      ...
      formatters={{
        formatCaption: (month, options) => {
          const formatted = month.toLocaleString(options?.locale?.code || "es", { month: "long", year: "numeric" });
          return formatted.replace(" de ", " ").charAt(0).toUpperCase() + formatted.replace(" de ", " ").slice(1);
        },
      }}
      classNames={{
        ...
        nav_button: cn(buttonVariants({ variant: "ghost" }), "h-7 w-7 p-0 hover:opacity-100 text-blue-600"),
        ...
        day_outside: "text-gray-400 aria-selected:bg-blue-100 aria-selected:text-gray-500",
